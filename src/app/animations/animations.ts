...
export const Animations = [
    trigger('mover-fotografias', [
        transition('*=>right', [
            ...
            group([
                ...
                query('.btn-leer-mas', animate('600ms 1200ms cubic-bezier(0.25, 0.46, 0.45, 0.94)', keyframes([
                ...
                query('.linea-inferior', animate('500ms 900ms cubic-bezier(0.25, 0.46, 0.45, 0.94)', style('*'))),
                query('.data-fotografia', animate('500ms 900ms cubic-bezier(0.25, 0.46, 0.45, 0.94)', style('*')))
            ])
        ]),
        transition('*=>left', [
            style({ transform: 'translateX(-100%)' }),
    ...
    trigger('show-thumbs', [
        ...
        transition('*=>void', [
            group([
                ...
                query('.item-fotografia', stagger(40, [
                    animate('400ms cubic-bezier(0.165, 0.84, 0.44, 1)', style({ transform: 'translateY(100%)' }))
                ]))
            ])
        ])
    ]),
    ...
    trigger('anim-admin', [
        ...
        transition(':leave', [
            query('.content', animate('400ms cubic-bezier(0.6, -0.28, 0.735, 0.045)',
